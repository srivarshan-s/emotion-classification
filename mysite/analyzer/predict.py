from .test.preprocessing.contraction import clean_contractions
from .test.preprocessing.misspelling import correct_spelling
from .test.preprocessing.clean import *
from .test.preprocessing.punctuations import *
...
def predict(text):
    model = pickle.load(open("analyzer/test/models/cust_bert_model.pkl", "rb"))
